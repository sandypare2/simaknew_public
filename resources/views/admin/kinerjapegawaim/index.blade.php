...
@section('title', 'Penilaian Talenta | SIMAK')
@section('sub-title', 'Penilaian Talenta ' )
                    ...
                    <div class="card-body">
                        ...
                        <div class="row flex-grow-1">
                            <div class="col-md-12 grid-margin">
                                <button type="button" id="formsimkp" class="btn btn-info btn-sm"><i class="ri-printer-line me-1"></i>Form SIMKP Kolektif</button>
                                <button type="button" id="proses_talenta" class="btn btn-success btn-sm"><i class="ri-settings-3-line me-1"></i>Finalisasi Talenta</button>
                                <button type="button" id="reset_talenta" class="btn btn-danger btn-sm"><i class="ri-refresh-line me-1"></i>Reset Finalisasi</button>
                            </div>
                        </div>  
                    </div>
                </div>
                ...
                <div class="table-responsive">
                    <table id="tbl_list" class="table data-table-responsive table-hover align-middle table table-nowrap w-100 custom-table">
                        ...
                        <tr>
                            ...
                            <th colspan="11" class="center">Semester 1</th>
                            <th colspan="11" class="center">Semester 2</th>
                        </tr>
                        <tr>
                            <th>Kuantitas (A)</th>
                            <th>PDP</th>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header d-flex justify-content-between align-items-center">
                <h5 class="modal-title font-size-13" id="modelHeading"></h5>
                ...
                <form id="dataForm" name="dataForm" class="form-horizontal">
                    ...
                    <div class="mb-2">
                        ...
                        <div class="input-group input-group-merge">
                            <input type="text" class="form-control form-control-sm" id="tahun_periode" name="tahun_periode" placeholder="" aria-label="" aria-describedby="basic-icon-default-fullname2" readonly />
                        </div>
                    </div>
                    <div class="mb-2">
                    ...
                    <div class="mb-2">
                        <label class="form-label-custom text-muted fs-13" for="basic-icon-default-fullname">Semester</label>
                        <div class="input-group input-group-merge">
                            <input type="text" class="form-control form-control-sm" id="semester" name="semester" placeholder="" aria-label="" aria-describedby="basic-icon-default-fullname2" readonly />
                            <!-- <select id="semester" name="semester" class="form-control form-select select2" style="width:100%;" readonly>
                    ...
                    <!-- <div class="mb-2">
                        <div class="row flex-grow-1">
                            <div class="col-md-6">
                                <label class="form-label-custom text-muted fs-13" for="basic-icon-default-fullname">Nilai Kuantitas-A (%)</label>
                                <div class="input-group input-group-merge">
                                    <input type="text" class="form-control form-control-sm" id="nilai_semester" name="nilai_semester" onkeypress="return isNumberKey2(event)" placeholder="" aria-label="" aria-describedby="basic-icon-default-fullname2" />
                                </div>
                            </div>
                            <div class="col-md-6">
                                <label class="form-label-custom text-muted fs-13" for="basic-icon-default-fullname">Nilai PDP (%)</label>
                                <div class="input-group input-group-merge">
                                    <input type="text" class="form-control form-control-sm" id="pdp_semester" name="pdp_semester" onkeypress="return isNumberKey2(event)" placeholder="" aria-label="" aria-describedby="basic-icon-default-fullname2" />
                                </div>
                            </div>
                        </div>
                    </div> -->
                    <div class="mb-2">
                        <div class="row flex-grow-1">
                            <div class="col-md-6">
                                <label class="form-label-custom text-muted fs-13" for="basic-icon-default-fullname">Nilai Kuantitas (%) => Positif</label>
                                <div class="input-group input-group-merge">
                                    <input type="text" class="form-control form-control-sm" id="kuantitas_semester" name="kuantitas_semester" onkeypress="return isNumberKey2(event)" placeholder="" aria-label="" aria-describedby="basic-icon-default-fullname2" />
                                </div>
                            </div>
                            <div class="col-md-6">
                                <label class="form-label-custom text-muted fs-13" for="basic-icon-default-fullname">Skor Kuantitas</label>
                                <div class="input-group input-group-merge">
                                    <input type="text" class="form-control form-control-sm" id="skor_kuantitas_semester" name="skor_kuantitas_semester" onkeypress="return isNumberKey2(event)" placeholder="" aria-label="" aria-describedby="basic-icon-default-fullname2" readonly />
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="mb-2">
                        <div class="row flex-grow-1">
                            <div class="col-md-6">
                                <label class="form-label-custom text-muted fs-13" for="basic-icon-default-fullname">Nilai Kualitas (%) => Positif</label>
                                <div class="input-group input-group-merge">
                                    <input type="text" class="form-control form-control-sm" id="kualitas_semester" name="kualitas_semester" onkeypress="return isNumberKey2(event)" placeholder="" aria-label="" aria-describedby="basic-icon-default-fullname2" />
                                </div>
                            </div>
                            <div class="col-md-6">
                                <label class="form-label-custom text-muted fs-13" for="basic-icon-default-fullname">Skor Kualitas</label>
                                <div class="input-group input-group-merge">
                                    <input type="text" class="form-control form-control-sm" id="skor_kualitas_semester" name="skor_kualitas_semester" onkeypress="return isNumberKey2(event)" placeholder="" aria-label="" aria-describedby="basic-icon-default-fullname2" readonly />
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="mb-2">
                        <div class="row flex-grow-1">
                            <div class="col-md-6">
                                <label class="form-label-custom text-muted fs-13" for="basic-icon-default-fullname">Nilai Waktu (%) => Positif</label>
                                <div class="input-group input-group-merge">
                                    <input type="text" class="form-control form-control-sm" id="waktu_semester" name="waktu_semester" onkeypress="return isNumberKey2(event)" placeholder="" aria-label="" aria-describedby="basic-icon-default-fullname2" />
                                </div>
                            </div>
                            <div class="col-md-6">
                                <label class="form-label-custom text-muted fs-13" for="basic-icon-default-fullname">Skor Waktu</label>
                                <div class="input-group input-group-merge">
                                    <input type="text" class="form-control form-control-sm" id="skor_waktu_semester" name="skor_waktu_semester" onkeypress="return isNumberKey2(event)" placeholder="" aria-label="" aria-describedby="basic-icon-default-fullname2" readonly />
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="mb-2">
                        <div class="row flex-grow-1">
                            <div class="col-md-6">
                                <label class="form-label-custom text-muted fs-13" for="basic-icon-default-fullname">NSK (Skor)</label>
                                <div class="input-group input-group-merge">
                                    <input type="text" class="form-control form-control-sm" id="skor_kinerja_semester" name="skor_kinerja_semester" onkeypress="return isNumberKey2(event)" placeholder="" aria-label="" aria-describedby="basic-icon-default-fullname2" />
                                </div>
                            </div>
                            <div class="col-md-6">
                                <label class="form-label-custom text-muted fs-13" for="basic-icon-default-fullname">NSK (Huruf)</label>
                                <div class="input-group input-group-merge">
                                    <input type="text" class="form-control form-control-sm" id="huruf_kinerja_semester" name="huruf_kinerja_semester" onkeypress="return isNumberKey2(event)" placeholder="" aria-label="" aria-describedby="basic-icon-default-fullname2" readonly />
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="mb-2">
                        <div class="row flex-grow-1">
                            <div class="col-md-6">
                                <label class="form-label-custom text-muted fs-13" for="basic-icon-default-fullname">NKI (Skor) <label id="lblrange" style="color:blue"></label></label>
                                <div class="input-group input-group-merge">
                                    <input type="text" class="form-control form-control-sm" id="skor_individu_semester" name="skor_individu_semester" onkeypress="return isNumberKey2(event)" placeholder="" aria-label="" aria-describedby="basic-icon-default-fullname2" />
                                </div>
                            </div>
                            <div class="col-md-6">
                                <label class="form-label-custom text-muted fs-13" for="basic-icon-default-fullname">NKI (Huruf)</label>
                                <div class="input-group input-group-merge">
                                    <input type="text" class="form-control form-control-sm" id="huruf_individu_semester" name="huruf_individu_semester" onkeypress="return isNumberKey2(event)" placeholder="" aria-label="" aria-describedby="basic-icon-default-fullname2" readonly />
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="mb-2">
                        <div class="row flex-grow-1">
                            <div class="col-md-6">
                                <label class="form-label-custom text-muted fs-13" for="basic-icon-default-fullname">Nilai Talenta</label>
                                <div class="input-group input-group-merge">
                                    <input type="text" class="form-control form-control-sm" id="nilai_talenta_semester" name="nilai_talenta_semester" onkeypress="return isNumberKey2(event)" placeholder="" aria-label="" aria-describedby="basic-icon-default-fullname2" readonly />
                                </div>
                            </div>
                            <div class="col-md-6">
                                <label class="form-label-custom text-muted fs-13" for="basic-icon-default-fullname">Nama Talenta</label>
                                <div class="input-group input-group-merge">
                                    <input type="text" class="form-control form-control-sm" id="nama_talenta_semester" name="nama_talenta_semester" onkeypress="return isNumberKey2(event)" placeholder="" aria-label="" aria-describedby="basic-icon-default-fullname2" readonly />
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="modal-footer">
                <button type="button" id="hitungBtn" class="btn btn-info"><i class="ri-calculator-line me-1"></i>Hitung NSK</button>
...
$(function() {
    ...
    document.querySelector('div.head-label_tbl_list').innerHTML = '<h5 class="card-title text-nowrap mb-0">Data Penilaian</h5>';
    ...
    $('#formsimkp').on("click", function() {
        var tahuncari = $("#tahuncari").val();
        var semestercari = $("#semestercari").val();
        var nipcari = "semua";
        window.open("formsimkp?tahuncari="+tahuncari+"&semestercari="+semestercari+"&nipcari="+nipcari);
    });         

    $('#proses_talenta').on("click", function(e) {
        var tahuncari = $("#tahuncari").val();
        var semestercari = $("#semestercari").val();
        ...
        Swal.fire({
            title: '',
            text: "Proses finalisasi talenta?",
            icon: 'warning',
            ...
            if (result.isConfirmed) {
                ...
                // $btn.html(spinner);
                $.ajax({
                    url: "{{url('api/proses-talenta-kinerjapegawaim')}}",
                    type: "POST",
                    data: {
                        tahun: tahuncari,
                    ...
                    success: function (data) { 
                        ...
                        if(data.status === "sukses"){  
                            Swal.fire('Sukses','Sukses finalisasi talenta.', 'success').then(() => table.draw());
                        } else {
                            Swal.fire('Error', 'Sukses finalisasi talenta.', 'error');
                        }                    
                    },
                    error: function (data) {
    ...
    $('#reset_talenta').on("click", function(e) {
        var tahuncari = $("#tahuncari").val();
        var semestercari = $("#semestercari").val();
        var kd_areacari = $("#kd_areacari").val();
        event.preventDefault();
        Swal.fire({
            title: '',
            text: "Reset finalisasi talenta?",
            icon: 'warning',
            showCancelButton: true,
            // confirmButtonColor: 'text-danger',
            // cancelButtonColor: 'text-secondary', // gray
            ...
            if (result.isConfirmed) {
                ...
                $.ajax({
                    url: "{{url('api/reset-talenta-kinerjapegawaim')}}",
                    type: "POST",
                    data: {
                        tahun: tahuncari,
                        semester: semestercari,
                    ...
                    success: function (data) { 
                        ...
                        $btn.prop('disabled', false).data('loading', false);
                        if(data.status === "sukses"){  
                            Swal.fire('Sukses','Sukses reset finalisasi talenta.', 'success').then(() => table.draw());
                        } else {
                            Swal.fire('Error', 'Gagal reset finalisasi talenta.', 'error');
                        }                    
                    },
                    error: function (data) {
                        // console.log('Error:', data);
    ...
    $('body').on('click', '.form_simkp', function () {
        var tahuncari = $(this).data('tahun');
        var semestercari = $(this).data('semester');
    ...
    $('body').on('click', '.edit_row', function () {
        ...
        $.get("{{ route('kinerjapegawaim') }}" +'/' + id, function (data) {   
            $('#modelHeading').html("Update Penilaian Talenta");
            ...
            if(parseInt(semestercari)===1){
                // alert('semester1');
                // if(data.nilai_semester1!==null && data.nilai_semester1!==undefined && data.nilai_semester1!=='' && parseFloat(data.nilai_semester1)>0){
                //     var nilai_semester1 = data.nilai_semester1+'%';
                // } else {
                //     var nilai_semester1 = data.rata_rata_semester1+'%';
                // }
                $('#semester').val('semester1').trigger('change');
                // $('#nilai_semester').val(data.nilai_semester1).trigger('change');
                // $('#pdp_semester').val(data.pdp_semester1).trigger('change');
                if(data.kuantitas_semester1!==null && data.kuantitas_semester1!==undefined && data.kuantitas_semester1!=='' && filterFloat(data.kuantitas_semester1)>0){
                    var kuantitas_semester1 = data.kuantitas_semester1;
                } else {
                    var kuantitas_semester1 = data.rata_kuantitas_semester1+'%';
                }
                if(data.kualitas_semester1!==null && data.kualitas_semester1!==undefined && data.kualitas_semester1!=='' && filterFloat(data.kualitas_semester1)>0){
                    var kualitas_semester1 = data.kualitas_semester1;
                } else {
                    var kualitas_semester1 = data.rata_kualitas_semester1+'%';
                }
                if(data.waktu_semester1!==null && data.waktu_semester1!==undefined && data.waktu_semester1!=='' && filterFloat(data.waktu_semester1)>0){
                    var waktu_semester1 = data.waktu_semester1;
                } else {
                    var waktu_semester1 = data.rata_waktu_semester1+'%';
                }
                if(parseFloat(kuantitas_semester1.replace('%', ''))==0){
                    kuantitas_semester1 = '';
                }
                if(parseFloat(kualitas_semester1.replace('%', ''))==0){
                    kualitas_semester1 = '';
                }
                if(parseFloat(waktu_semester1.replace('%', ''))==0){
                    waktu_semester1 = '';
                }                
                ...
                // $('#nilai_semester').val(nilai_semester2).trigger('change');
                // $('#pdp_semester').val(data.pdp_semester2).trigger('change');
                if(data.kuantitas_semester2!==null && data.kuantitas_semester2!==undefined && data.kuantitas_semester2!=='' && filterFloat(data.kuantitas_semester2)>0){
                    var kuantitas_semester2 = data.kuantitas_semester2;
                } else {
                    var kuantitas_semester2 = data.rata_kuantitas_semester2+'%';
                }
                if(data.kualitas_semester2!==null && data.kualitas_semester2!==undefined && data.kualitas_semester2!=='' && filterFloat(data.kualitas_semester2)>0){
                    var kualitas_semester2 = data.kualitas_semester2;
                } else {
                    var kualitas_semester2 = data.rata_kualitas_semester2+'%';
                }
                if(data.waktu_semester2!==null && data.waktu_semester2!==undefined && data.waktu_semester2!=='' && filterFloat(data.waktu_semester2)>0){
                    var waktu_semester2 = data.waktu_semester2;
                } else {
                    var waktu_semester2 = data.rata_waktu_semester2+'%';
                }
                if(parseFloat(kuantitas_semester2.replace('%', ''))==0){
                    kuantitas_semester2 = '';
                }
                if(parseFloat(kualitas_semester2.replace('%', ''))==0){
                    kualitas_semester2 = '';
                }
                if(parseFloat(waktu_semester2.replace('%', ''))==0){
                    waktu_semester2 = '';
                }                
                // alert(data.rata_kuantitas_semester2);
                $('#kuantitas_semester').val(kuantitas_semester2).trigger('change');
                $('#kualitas_semester').val(kualitas_semester2).trigger('change');
                $('#waktu_semester').val(waktu_semester2).trigger('change');
...
@section('js')
    ...
    $(function () {
        ...
        //     // if((nilai_semester!=="" && nilai_semester!==null && nilai_semester!==undefined) || (pdp_semester!=="" && pdp_semester!==null && pdp_semester!==undefined)){
        //         var kuantitas_semester = filterFloat(nilai_semester)+filterFloat(pdp_semester);
        //         // alert(kuantitas_semester);
        ...
        //     // }
        //     // alert(nilai_semester+" "+pdp_semester);
        // });
        ...
        $('#kuantitas_semester').on('change', function () {
            ...
            if(nilai2!=="" && nilai2!==null && parseInt(nilai2)>0){
        ...
        //     var nilai3 = $("#skor_waktu_semester").val();
        //     var pembagi = 0;
        //     if(nilai1!=="" && nilai1!==null && parseFloat(nilai1)>0){
        //         pembagi++;
        //     }
        //     if(nilai2!=="" && nilai2!==null && parseFloat(nilai2)>0){
        //         pembagi++;
        //     }
        //     if(nilai3!=="" && nilai3!==null && parseFloat(nilai3)>0){
        //         pembagi++;
        //     }
        //     var skor_kinerja = Math.round((filterFloat(nilai1)+filterFloat(nilai2)+filterFloat(nilai3))/pembagi);
        //     if(!isNaN(skor_kinerja)){
