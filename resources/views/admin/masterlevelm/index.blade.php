...
@section('title', 'Master Level | SIMAK')
@section('sub-title', 'Master Level ' )
                    ...
                    <div class="card-body">
                        <div class="row flex-grow-1">
                            <div class="col-md-3 grid-margin">
                                <select id="jenis_kpicari" name="jenis_kpicari" class="select2 form-control form-control-sm" data-allow-clear="true">
                            ...
                            <div class="col-md-9 grid-margin">
                                ...
                                <a title="Input Data" class="add_row"><button type="button" class="btn btn-primary btn-sm"><i class="ri-add-line me-1"></i>Input Data</button></a></p>
                            </div>
                        </div>    
                    </div>
                </div>
                ...
                <form id="dataForm" name="dataForm" class="form-horizontal">
                    ...
                    <div class="mb-2">
                        ...
                        <div class="input-group input-group-merge">
                            <select id="jenis_kpi" name="jenis_kpi" class="select2 form-control form-control-sm" data-allow-clear="true" style="width:100%;">
                    ...
                    <div class="mb-2">
                        <label class="form-label-custom text-muted fs-13" for="basic-icon-default-fullname">Level</label>
                        <div class="input-group input-group-merge">
                            <select id="level_kpi" name="level_kpi" class="select2 form-control form-control-sm" data-allow-clear="true" style="width:100%;">
                    ...
                    <div class="mb-2">
                        <label class="form-label-custom text-muted fs-13" for="basic-icon-default-fullname">Keterangan</label>
                        <div class="input-group input-group-merge">
                            <input type="text" class="form-control form-control-sm" id="nama_level_kpi" name="nama_level_kpi" placeholder="" aria-label="" aria-describedby="basic-icon-default-fullname2" />
                        </div>
                    </div>
                </form>
            </div>
...
$(function() {
    ...
    var table = $('#tbl_list').DataTable({
        ...
        columns: [
            ...
            {data: 'jenis_kpi',name:'jenis_kpi',width:'80px',className: 'dt-center'},
            {data: 'level_kpi',name:'level_kpi',width:'80px',className: 'dt-center'},
            {data: 'nama_level_kpi',name:'nama_level_kpi',width:'300px',className: 'dt-left wrap'},
        ],
        columnDefs: [
        {
    ...
    document.querySelector('div.head-label_tbl_list').innerHTML = '<h5 class="card-title text-nowrap mb-0">Data Master Level</h5>';
    ...
    $('.add_row').click(function () {
        ...
        $('#modelHeading').html("Input Level KPI");
        $('#ModalForm').modal('show');
    });        
    
    $('body').on('click', '.edit_row', function () {
        var id = $(this).data('id');
        $.get("{{ route('masterlevelm') }}" +'/' + id, function (data) {                
            $('#modelHeading').html("Edit Level KPI");
            $('#ModalForm').modal('show');
            $('#id').val(data.id);
        ...
        swal({
            ...
            if (willDelete) {
                $.ajax({
                    ...
                    url: "{{url('api/hapus-masterlevelm')}}",
                    success: function (data) {
                        swal({
                            title: "Result",
                            text: 'Sukses hapus data level kpi',
                            icon: "info",
                            type: "success",
                            dangerMode: false,
                        })                            
