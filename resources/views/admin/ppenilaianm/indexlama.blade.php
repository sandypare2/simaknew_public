                ...
                <form id="dataForm" name="dataForm" class="form-horizontal">
                    ...
                    <div class="mb-2">
                        ...
                        <div class="input-group input-group-merge">
                            <input type="text" class="form-control" id="tahun" name="tahun" onkeypress="return isNumberKey(event)" placeholder="" aria-label="" aria-describedby="basic-icon-default-fullname2" />
                        </div>
                    </div>
                    <div class="mb-2">
...
<script type="text/javascript">
    $(function () {                 
        ...
        var table = $('#tbl_list').DataTable({
            ...
            columnDefs: [
            {
                targets: [2], render: function (a, b, data, d) { 
                    if(data.semester!=="" && data.semester!==null && data.semester!==undefined){
        ...
        $('.add_row').click(function () {
            ...
            $('#modelHeading').html("Input Periode Penilaian");
        ...
        $('body').on('click', '.edit_row', function () {
            var id = $(this).data('id');
            $.get("{{ route('ppenilaianm') }}" +'/' + id, function (data) {                
                $('#modelHeading').html("Edit Periode Penilaian");
                $('#ModalForm').modal('show');
                if(data.tgl_awal!==""){
            ...
            swal({
                ...
                if (willDelete) {
                    $.ajax({
                        ...
                        url: "{{url('api/hapus-ppenilaianm')}}",
                        success: function (data) {
                            swal({
                                title: "Result",
                                text: 'Sukses hapus data periode penilaian',
                                icon: "info",
                                type: "success",
                                dangerMode: false,
                            })                            
