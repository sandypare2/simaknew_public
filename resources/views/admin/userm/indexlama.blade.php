    ...
    <div class="card">
        <div class="row flex-grow-1" style="margin-left:10px;margin-right:10px;margin-top:20px;">
            <div class="col-md-3 grid-margin">
                <select id="kd_afiliasicari" name="kd_afiliasicari" class="select2 form-select form-select-sm" data-allow-clear="true">
            ...
            <div class="col-md-3 grid-margin">
                <button id="filternya" class="btn btn-xs btn-info" style="min-width:80px;color:#fff;"><i class="fa fa-search putih" style="margin-right:10px;"></i>Filter Data</button>
            ...
            <div class="col-md-3 grid-margin">
                <small class="float-end" style="font-weight:bold;">DATA PENGGUNA</small>
            </div>
        </div>    
        ...
        <div class="card">
            ...
            <div class="card-body"> 
                <form id="dataForm" name="dataForm" class="form-horizontal">
                    ...
                    <div class="mb-6">
                        <label class="form-label" for="basic-icon-default-fullname">Akses Afiliasi</label>
                        <div class="input-group input-group-merge">
            ...
            <div class="card-footer">
                <button type="button" id="saveBtn" class="btn btn-primary"><span class="ti-xs ti ti-device-floppy me-3"></span>Simpan</button>
                <button type="button" class="btn btn-label-secondary" data-bs-dismiss="modal"><span class="ti-xs ti ti-circle-x me-3"></span>Cancel</button>
            </div>            
        </div>
    </div>
</div>
...
<script src="https://cdnjs.cloudf1lare.com/ajax/libs/sweetalert/2.1.2/sweetalert.min.js"></script>
<style>
.swal-title {
...
<script type="text/javascript">
    $(function () {                 
        ...
        $('.add_row').click(function () {
            ...
            if(kd_afiliasicari!=="semua"){
                $('#kd_afiliasi').val(kd_afiliasicari).trigger('change');
            } else {
                $('#kd_afiliasi').val('').trigger('change');
            }
        });        
        
        $('body').on('click', '.edit_row', function () {
            var id = $(this).data('id');
            // $.get("{{ route('userm') }}" +'/' + id +'/edit', function (data) {
