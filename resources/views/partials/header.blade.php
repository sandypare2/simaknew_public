    ...
    <div class="nav-header">
      ...
      <div class="header-left hstack gap-3">
        ...
        <div class="app-sidebar-logo app-horizontal-logo justify-content-center align-items-center">
          <a href="index">
            <img height="30" class="app-sidebar-logo-default" alt="Logo" loading="lazy" src="{{ asset('assets/images/pcnnew.png') }}">
            <img height="40" class="app-sidebar-logo-minimize" alt="Logo" loading="lazy" src="{{ asset('assets/images/pln.png') }}">
          </a>
        </div>
        ...
        <div class="dropdown features-dropdown">
          ...
          <!-- <form class="d-none d-sm-block header-search" data-bs-toggle="dropdown" aria-expanded="false">
            <div class="form-icon">
              <input type="search" class="form-control form-control-icon" id="firstNameLayout4" placeholder="Search in SI-SUPER" required>
      ...
      <div class="header-right hstack gap-3">
        ...
        <div class="dropdown profile-dropdown features-dropdown">
          <button type="button" id="accountNavbarDropdown" class="btn profile-btn shadow-none px-0 hstack gap-0 gap-sm-3" data-bs-toggle="dropdown" aria-expanded="false" data-bs-auto-close="outside" data-bs-dropdown-animation>
            <span class="position-relative">
              <span class="avatar-item avatar overflow-hidden">
                <img class="img-fluid" src="{{ asset('assets/images/avatar/avatar1.png') }}" alt="avatar image">
              </span>
              <span class="position-absolute border-2 border border-white h-12px w-12px rounded-circle bg-success end-0 bottom-0"></span>
            </span>
            <span>
              <span class="h6 d-none d-xl-inline-block text-start fw-semibold mb-0">{{ Auth::user()->nama ?? 'Guest' }}</span>
          ...
          <div class="dropdown-menu dropdown-menu-end header-language-scrollable" aria-labelledby="accountNavbarDropdown">
            ...
            <a class="dropdown-item" href="../pages-profile-overview">
            ...
            <a class="dropdown-item" href="../pages-profile-edit-overview">
              <div class="d-flex align-items-center">
                <div class="flex-shrink-0">
                  <div class="avatar avatar-md bg-warning text-white rounded-circle d-flex align-items-center justify-content-center p-0">
                      <i class="ri-logout-box-r-line m-0"></i>
                  </div>
                </div>              
                <div class="flex-grow-1 ms-2">
                  <span class="card-text">Setting</span>
                </div>
              </div>
            </a> -->
            ...
            <a class="dropdown-item" href="{{ route('logout') }}">
              ...
              <div class="d-flex align-items-center">
                <div class="flex-shrink-0">
                    <i class="ri-logout-box-r-line m-0 text-danger"></i>
                </div>              
                <div class="flex-grow-1 ms-2">
                  <span class="card-text text-danger">Sign out</span>
                </div>
              </div>
            </a>
          </div>
