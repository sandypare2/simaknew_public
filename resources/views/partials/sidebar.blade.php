...
<aside class="app-sidebar">
    ...
    <div class="app-sidebar-logo px-6 justify-content-center align-items-center">
        <a href="index">
            <img height="45" class="app-sidebar-logo-default" alt="Logo" src="{{ asset('assets/images/pcnnew.png') }}">
            <img height="40" class="app-sidebar-logo-minimize" alt="Logo" src="{{ asset('assets/images/pln.png') }}">
        </a>
    </div>
    <!-- END BRAND LOGO -->
...
<div class="offcanvas offcanvas-md offcanvas-start small-screen-sidebar" data-bs-scroll="true" tabindex="-1" id="smallScreenSidebar" aria-labelledby="smallScreenSidebarLabel">
    <div class="offcanvas-header hstack border-bottom">
        ...
        <div class="app-sidebar-logo">
            <a href="index">
                <img height="35" class="app-sidebar-logo-default h-25px" alt="Logo" src="{{ asset('assets/images/pcnnew.png') }}">">
                <img height="40" class="app-sidebar-logo-minimize" alt="Logo" src="{{ asset('assets/images/pln.png') }}">">
            </a>
        </div>
